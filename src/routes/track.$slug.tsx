...
function TrackPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10 md:px-6 md:py-16">
      ...
      <div className="mt-8 grid items-start gap-8 md:grid-cols-[minmax(0,18rem)_minmax(0,1fr)] md:gap-8 lg:grid-cols-[minmax(0,22rem)_minmax(0,1fr)] lg:gap-10">
        ...
        <div className="min-w-0">
          ...
          {track.inscription ? (
            <blockquote className="mt-5 max-w-xl border-l-2 border-gold pl-4 font-display text-lg italic leading-snug text-gold-bright">
              {track.inscription}
            </blockquote>
          ) : null}
          {track.notes ? (
          ...
          {hasLedger ? (
            <dl className="mt-8 grid gap-x-6 gap-y-4 overflow-hidden rounded-xl bg-surface p-5 shadow-[0_0_0_1px_rgb(255_255_255/0.08)] sm:grid-cols-2 md:p-6">
              {audio?.registry ? (
      ...
      {lyrics ? (
        <section className="mt-16 border-t border-line pt-16 md:mt-20">
